                ...
                <div class="selected-version">
                    ...
                    <div class="file-specs">
                        <div class="spec-item">
                            ...
                            <div class="spec-details">
                                <span class="spec-label">{{
                                    $t('download.options.fileSpecs.fileSize')
                                }}</span>
                                <span class="spec-value">{{ file_size }}</span>
                            </div>
                        </div>
                        <div class="spec-item">
                            <div class="spec-icon">☕</div>
                            <div class="spec-details">
                                <span class="spec-label">{{
                                    $t('download.options.fileSpecs.javaVersion')
                                }}</span>
                        ...
                        <div class="spec-item">
                            ...
                            <div class="spec-details">
                                <span class="spec-label">{{
                                    $t('download.options.fileSpecs.buildNumber')
                                }}</span>
                                <span class="spec-value">#{{ latest_build }}</span>
                            </div>
                        </div>
                        <div class="spec-item">
                            <div class="spec-icon">📅</div>
                            <div class="spec-details">
                                <span class="spec-label">{{
                                    $t('download.options.fileSpecs.releaseDate')
                                }}</span>
...
const latest_build = ref<string | undefined>()
...
const published_at = ref<string | undefined>()
...
onMounted(async () => {
    ...
    latest_build.value = release_call.data?.tag_name.split('-')[1]
