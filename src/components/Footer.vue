            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <div class="social-links">
                        <a href="https://github.com/MenthaMC" target="_blank" class="social-link" aria-label="GitHub">
                        ...
                        <a href="https://discord.com/invite/PK4YAtAHpr" target="_blank" class="social-link" aria-label="Discord">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                <path
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        ...
                        <li>
                            <router-link to="/download" class="footer-link">{{
