<template>
    <div
        ...
        :data-featured-text="$t('home.projects.featured')"
    >
        ...
        <div class="project-actions">
            <button class="btn-primary" @click="handleDetail">
                {{ $t('home.projects.actions.viewDetail') }}
            </button>
            <button class="btn-secondary" @click="handleGitHub">
                {{ $t('home.projects.actions.github') }}
            </button>
        </div>
    </div>
</template>
